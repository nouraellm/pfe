...
{
    public partial class Form_listeIntervention_termine : Form
    {
        public Form_listeIntervention_termine()
        {
            InitializeComponent();
        }
        Class1 c = new Class1();
        private void Form_listeIntervention_termine_Load(object sender, EventArgs e)
        {
            c.da3 = new SqlDataAdapter("select * from intervention where etat='Termine'", c.cnx);
            c.da3.Fill(c.ds, "int_t");
            dataGridView1.DataSource = c.ds.Tables["int_t"];
