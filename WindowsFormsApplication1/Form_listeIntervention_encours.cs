...
{
    public partial class Form_listeIntervention_encours : Form
    {
        public Form_listeIntervention_encours()
        {
            InitializeComponent();
        }
        Class1 c = new Class1();
        private void Form_listeIntervention_Load(object sender, EventArgs e)
        {
            c.da3 = new SqlDataAdapter("select * from intervention where etat='En Cours'", c.cnx);
            c.da3.Fill(c.ds, "int_e");
            dataGridView1.DataSource = c.ds.Tables["int_e"];
